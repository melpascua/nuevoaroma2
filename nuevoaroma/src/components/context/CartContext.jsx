...
export const Proveedor = ({ children }) => {
    ...
    const obtenerTotal = () => {
        let total = 0
        carrito.forEach((e) => total += (e.quantity * e.price))
        return total
    };
    ...
    const eliminarProducto = (prodId) => {
        ...
        return (
            <CartContext.Provider value={{ carrito, agregarProducto, eliminarProducto, limpiar, enElCarrito, productoAgregado, obtenerTotal, obtenerCantidad }}>
                {children}
